# Skill Registry — p---lavadero-berazategui
...
- C:\Users\Facundo Rombola\.config\opencode\skills
- C:\Users\Facundo Rombola\.claude\skills
- C:\Users\Facundo Rombola\.gemini\skills
- C:\Users\Facundo Rombola\.gemini\antigravity\skills
- C:\Users\Facundo Rombola\.cursor\skills
- C:\Users\Facundo Rombola\.copilot\skills
...
### branch-pr
- Path: C:\Users\Facundo Rombola\.config\opencode\skills\branch-pr\SKILL.md
...
### chained-pr
- Path: C:\Users\Facundo Rombola\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\Facundo Rombola\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\Facundo Rombola\.config\opencode\skills\comment-writer\SKILL.md
...
### go-testing
- Path: C:\Users\Facundo Rombola\.config\opencode\skills\go-testing\SKILL.md
...
### issue-creation
- Path: C:\Users\Facundo Rombola\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\Facundo Rombola\.config\opencode\skills\judgment-day\SKILL.md
...
### ponytail
- Path: C:\Users\Facundo Rombola\.claude\skills\ponytail\SKILL.md
- Rules:
...
### ponytail-audit
- Path: C:\Users\Facundo Rombola\.claude\skills\ponytail-audit\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### ponytail-debt
- Path: C:\Users\Facundo Rombola\.claude\skills\ponytail-debt\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### ponytail-gain
- Path: C:\Users\Facundo Rombola\.claude\skills\ponytail-gain\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### ponytail-help
- Path: C:\Users\Facundo Rombola\.claude\skills\ponytail-help\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### ponytail-review
- Path: C:\Users\Facundo Rombola\.claude\skills\ponytail-review\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: C:\Users\Facundo Rombola\.config\opencode\skills\skill-creator\SKILL.md
...
### update-docs
- Path: C:\Users\Facundo Rombola\.claude\skills\update-docs\SKILL.md
- Trigger: Keep BANU RH docs current after code changes. Trigger when docs may be stale after implementing features, fixing bugs, or changing business rules. Updates only what changed — never rewrites everything.
- Rules:
  - Never invent business logic. If the YAML PA source (`reference/powerapps/Src/`) contradicts the code, note the discrepancy — don't silently pick one.
  - Never remove existing "pending confirmation" notes unless you've verified the fact from code.
  - Keep docs in English (consistent with existing docs).
  - Do not update `docs/00_OVERVIEW.md` through `docs/04_SECURITY.md` — those are migration-era historical docs.

### work-unit-commits
- Path: C:\Users\Facundo Rombola\.config\opencode\skills\work-unit-commits\SKILL.md
